<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                <!-- Custom CASURECO Logo -->
<!-- Custom CASURECO Logo -->
<div class="shrink-0 flex items-center">
    <a href="{{ route('dashboard') }}" class="flex items-center">
        <img src="{{ asset('images/casureco-logo.png') }}" 
             alt="CASURECO II" 
             class="h-6 w-6 mr-2 object-contain">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <!-- PC Units -->
                    <x-nav-link :href="route('pc-units.index')" :active="request()->routeIs('pc-units.*')">
                        {{ __('PC Units') }}
                    </x-nav-link>
                    ...
                    <div class="relative group">
                        ...
                        <div class="absolute hidden group-hover:block bg-white shadow-lg rounded-lg mt-2 py-1 w-48 z-50">
                            <a href="{{ route('pc-history.report') }}" 
                               class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                                PC Assignment Report
                            </a>
                            <a href="#" 
                               class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                                Inventory Summary
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('pc-units.index')" :active="request()->routeIs('pc-units.*')">
                {{ __('PC Units') }}
            </x-responsive-nav-link>
            
            <x-responsive-nav-link :href="route('pc-history.index')" :active="request()->routeIs('pc-history.*')">
                {{ __('PC History') }}
            </x-responsive-nav-link>
        </div>
