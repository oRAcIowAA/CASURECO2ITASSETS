            ...
            <div class="bg-white rounded-xl shadow-md overflow-hidden mb-6">
                <div class="p-6">
                    ...
                    <div class="flex flex-col sm:flex-row flex-wrap gap-2 mb-6 pt-4 border-t border-gray-100">
                        ...
                        @if($statusStr === 'disposed')
                        <a href="{{ route('mobile-devices.print-disposal', $mobileDevice) }}" target="_blank" class="w-full sm:w-auto justify-center inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-semibold rounded-md text-gray-700 bg-white hover:bg-gray-50">
                            <svg class="mr-2 h-4 w-4 text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            @if(session('print_disposal'))
                window.open("{{ route('mobile-devices.print-disposal', $mobileDevice) }}", '_blank');
            @endif
        });
    </script>
</x-app-layout>
