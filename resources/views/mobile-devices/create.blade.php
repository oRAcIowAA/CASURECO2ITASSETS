    ...
    <div class="py-6">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-sm rounded-lg p-6">
                ...
                <form method="POST" action="{{ route('mobile-devices.store') }}" x-data="{ 
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="type" class="w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 uppercase" required>
                                <option value="CELLPHONE" {{ old('type', $type) == 'CELLPHONE' ? 'selected' : '' }}>CELLPHONE</option>
                            </select>
                    ...
                    <div class="flex justify-between items-center mt-6">
                        <a href="{{ route('mobile-devices.index') }}" class="text-gray-600 hover:text-gray-900 text-sm">
                            ← Back
                        </a>
                        <button type="submit"
