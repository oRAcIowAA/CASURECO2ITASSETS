            ...
            <div class="bg-white rounded-xl shadow-md overflow-hidden mb-6">
                <div class="p-6">
                    ...
                    <div class="flex flex-col sm:flex-row flex-wrap gap-2 mb-6 pt-4 border-t border-gray-100">
                        ...
                        @else
                            <a href="{{ route('pc-units.transfer', $pcUnit) }}" class="w-full sm:w-auto justify-center inline-flex items-center px-3 py-1.5 border border-indigo-200 text-sm font-medium rounded-md text-indigo-700 bg-indigo-50 hover:bg-indigo-100">
                            ...
                            <a href="{{ route('pc-units.dispose', $pcUnit) }}" class="w-full sm:w-auto justify-center inline-flex items-center px-3 py-1.5 border border-red-200 text-sm font-medium rounded-md text-red-700 bg-red-50 hover:bg-red-100">
                                ...
                                {{ strtolower($pcUnit->status) === 'condemned' ? 'Disposed' : 'Defective/Condemn' }}
                            </a>
                            
                            @if(strtolower($pcUnit->status) === 'defective')
                            <form method="POST" action="{{ route('pc-units.repair', $pcUnit) }}" class="inline w-full sm:w-auto">
                                @csrf
                        ...
                        <a href="{{ route('pc-units.print-label', $pcUnit) }}" target="_blank" class="w-full sm:w-auto justify-center inline-flex items-center px-3 py-1.5 border border-gray-200 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        ...
                        <div>
                            ...
                            <p class="text-lg font-semibold text-gray-900">{{ strtoupper($pcUnit->processor ?? 'N/A') }}</p>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <p class="text-lg font-semibold text-gray-900">{{ strtoupper($pcUnit->storage ?? 'N/A') }}</p>
                        </div>
                        <div>
                    ...
                    <div class="border-t border-gray-200 pt-6 mb-6">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                            <div>
                                ...
                                <p class="text-lg font-semibold text-gray-900">{{ strtoupper($pcUnit->department ?? 'N/A') }}</p>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-500 mb-1">DIVISION</label>
                                <p class="text-lg font-semibold text-gray-900">{{ strtoupper($pcUnit->division ?? 'N/A') }}</p>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-500 mb-1">GROUP</label>
                                <p class="text-lg font-semibold text-gray-900">{{ strtoupper($pcUnit->group ?? 'N/A') }}</p>
                            </div>
                            <div>
                                ...
                                <p class="text-lg font-semibold text-gray-900">
                                    ...
                                    @if($pcUnit->employee)
                                        <span class="text-sm text-gray-500">({{ strtoupper($pcUnit->employee->position) }})</span>
                                    @endif
                                </p>
                            </div>
                            <div>
