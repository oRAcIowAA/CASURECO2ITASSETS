    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <a href="{{ route('pc-units.create', ['type' => 'Desktop']) }}"
                    class="bg-white overflow-hidden shadow-md rounded-xl p-8 flex flex-col items-center justify-center hover:bg-blue-50 transition-all border-2 border-transparent hover:border-blue-500 group">
                    <div
                ...
                <a href="{{ route('printers.create') }}"
                    ...
                    <p class="text-sm text-gray-500 text-center mt-2">Printer, Scanner, and Portable printer
                        registration</p>
                </a>
                ...
                <!-- Power Utility (UPS / AVR) -->
                <a href="{{ route('power-utilities.create') }}"
                    class="bg-white overflow-hidden shadow-md rounded-xl p-8 flex flex-col items-center justify-center hover:bg-blue-50 transition-all border-2 border-transparent hover:border-blue-500 group">
                    <div
                        class="w-16 h-16 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                        <svg class="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <span class="text-xl font-bold text-gray-900">Power Utility</span>
                    <p class="text-sm text-gray-500 text-center mt-2">UPS and AVR units</p>
                </a>

                <!-- Mobile Device (Cellphone) -->
                <a href="{{ route('mobile-devices.create') }}"
                    class="bg-white overflow-hidden shadow-md rounded-xl p-8 flex flex-col items-center justify-center hover:bg-blue-50 transition-all border-2 border-transparent hover:border-blue-500 group">
                    <div
                        class="w-16 h-16 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                        <svg class="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <span class="text-xl font-bold text-gray-900">Mobile Device</span>
                    <p class="text-sm text-gray-500 text-center mt-2">Cellphone and other mobile units</p>
                </a>
            </div>
