                ...
                <div class="p-6">
                    ...
                    <form method="POST" action="{{ route('pc-units.condemn', $pcUnit) }}">
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="remarks" id="remarks" rows="4" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 uppercase" placeholder="e.g., Motherboard failure, expensive repair cost..." required oninput="this.value = this.value.toUpperCase()"></textarea>
                        </div>
                        ...
                        <div class="flex items-center justify-between mt-6">
                            ...
                            <button type="submit" class="px-4 py-2 bg-red-600 text-white rounded-md hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2">
                                {{ strtolower($pcUnit->status) === 'condemned' ? 'Disposed' : 'Confirm' }}
                            </button>
                        </div>
                    </form>
                </div>
