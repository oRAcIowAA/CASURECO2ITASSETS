    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6 flex justify-between items-end">
                <div>
                    <h3 class="text-lg font-semibold text-gray-900">
                        ALL PRINTER ASSIGNMENT RECORDS
                    </h3>
            ...
            <div class="mb-6 p-4 bg-gray-50 rounded-lg">
                <form method="GET" action="{{ route('printer-history.index') }}" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    <div class="col-span-1 md:col-span-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="search" placeholder="SEARCH PRINTER OR EMPLOYEE..." 
                            ...
                            @forelse($history as $log)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-indigo-600">
                                        <a href="{{ route('printers.show', $log->printer) }}" class="hover:underline">
                                            {{ $log->printer->brand }} {{ $log->printer->model }}
                                        </a>
                                    </td>
