                        ...
                        <div>
                            ...
                            <select name="location" class="w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 uppercase" required>
                                ...
                                @foreach($groups as $group)
                                    <option value="{{ $group }}" {{ old('location', $networkDevice->location) == $group ? 'selected' : '' }}>{{ strtoupper($group) }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div>
                            ...
                            <input type="date" name="date_issued" value="{{ old('date_issued', $networkDevice->date_issued?->format('Y-m-d')) }}"
                                   @if($networkDevice->date_issued) readonly @endif
                                   class="w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 @if($networkDevice->date_issued) bg-gray-100 text-gray-600 @endif"
                                   required>
