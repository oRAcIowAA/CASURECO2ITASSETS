        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg border border-gray-200 text-sm">
                ...
                <div class="px-6 py-4 bg-gray-50 border-b border-gray-200">
                    <h3 class="text-lg font-bold text-gray-800">Admin Account Credentials</h3>
                    <p class="text-xs text-gray-500 mt-1">This user will have full root access to the system. Provide a secure password.</p>
                </div>

                <form method="POST" action="{{ route('admins.store') }}" class="p-6">
                    @csrf

                    <!-- Name -->
                    <div class="mb-6">
                        <x-input-label for="name" :value="__('Full Name')" class="font-bold text-gray-700 uppercase tracking-wide text-xs mb-2" />
                        <x-text-input id="name" class="block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm uppercase" type="text" name="name" :value="old('name')" required autofocus oninput="this.value = this.value.toUpperCase()" />
                    ...
                    <div class="mb-6">
                        ...
                        <x-text-input id="email" class="block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" type="email" name="email" :value="old('email')" required />
                    ...
                    <div class="mb-6">
                        ...
                        <x-text-input id="password" class="block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" type="password" name="password" required autocomplete="new-password" />
                    ...
                    <div class="mb-6">
                        ...
                        <x-text-input id="password_confirmation" class="block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" type="password" name="password_confirmation" required />
                    ...
                    <div class="mb-6">
                        ...
                        <x-text-input id="security_question" class="block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm uppercase" type="text" name="security_question" :value="old('security_question')" placeholder="e.g., What is the name of your first pet?" required oninput="this.value = this.value.toUpperCase()" />
                    ...
                    <div class="mb-8">
                        ...
                        <x-text-input id="security_answer" class="block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm uppercase" type="text" name="security_answer" :value="old('security_answer')" required oninput="this.value = this.value.toUpperCase()" />
