            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg border border-gray-200 text-sm">
                ...
                <form method="POST" action="{{ route('admins.store') }}" class="p-6">
                    ...
                    <div class="mb-6">
                        ...
                        <x-text-input id="name" class="block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" type="text" name="name" :value="old('name')" required autofocus />
                    ...
                    <div class="mb-6">
                        ...
                        <x-text-input id="security_question" class="block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" type="text" name="security_question" :value="old('security_question')" placeholder="e.g., What is the name of your first pet?" required />
                    ...
                    <div class="mb-8">
                        ...
                        <x-text-input id="security_answer" class="block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" type="text" name="security_answer" :value="old('security_answer')" required />
